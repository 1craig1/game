...
// Indicates that this class is a JPA entity. It will be mapped to a database table.
@Entity
...
@Data /* Lombok annotation that generates boilerplate code for getters, setters,
toString(), equals(), and hashCode() at compile time. */
public class Game {
    // PK of table
    @Id
    ...
    @Column(nullable = false) // 'nullable = false' means NOT NULL.
