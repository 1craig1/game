...
class GameRepositoryIntegrationTest {
    ...
    void testFindUpcomingGamesAfterGivenDateAndOrderThemByReleaseDate() {
        ...
        pastGame.setReleaseDate(now.minus(10, ChronoUnit.DAYS));
        ...
        futureGame1.setReleaseDate(now.plus(10, ChronoUnit.DAYS));
        ...
        futureGame2.setReleaseDate(now.plus(30, ChronoUnit.DAYS));
    ...
    @Test
    @Transactional
    void shouldFindGamesByPlatformName() {
        // --- Setup ---
        ...
        // --- Action ---
        List<Game> foundGames = gameRepository.findByPlatforms_Name("PC");
    ...
    @Test
    @Transactional
    void shouldFindGamesByGenreName() { // --- RENAMED ---
        // --- Setup ---
